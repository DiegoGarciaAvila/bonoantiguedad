...
/**
 * PDOConsultas - Library of PHP functions for intracting database using PDO
 * File: PDOConsultas.php
 ...
 * Copyright (c) 2016 Pritesh Gupta. All Rights Reserved.
  ...
  /* ABOUT THIS FILE:
  ---------------------------------------------------------------------------------------------------------------
 * PDOConsultas Class provides set of functions for interacting database using PDO extension.
