        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header encabezado">
                    <div class="col-md-6 col-12 demo-inline-spacing" style="float:left; text-align:left;">
                        <h3 class="card-title"><b>CAPTURA <?= $entidad ?></b></h3><a href="<?= $_SERVER['HTTP_REFERER'] ?>">ATRÁS</a>
                        <?php
                        echo "<button class=\"btn btn-primary btn-icon m-1\" type=\"submit\" id=\"btn_envia_datos\">
                                                <span class=\"ul-btn__icon\"><i class=\"i-Gear-2\"></i></span>
                                                <span class=\"ul-btn__text\">" . $btn_guardar . "</span>
                                      </button>";
                        echo '<div class=" col-md-12 col-12 demo-inline-spacing" style=" float:right; text-align:right;">';
                        ?>
                        <small>
                            <font color="#F40000">Los datos (*) son obligatorios</font>
                        </small>
                        <?= '</div>' ?>
                    </div>
                    <div class="col-md-6 col-12 demo-inline-spacing" style="float:right; text-align:right;">
                        &nbsp;
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    foreach ($field as $key => &$val) {
                     ...
                     //   if($bandera && strlen($val[9]) > 0 && $val[9] != ''){
                     //       $valorpeticion = $val[9];
                     //       GLOBAL $global;
                     //        $global = $val[9];
                     //       print_r($val[9]);
...
<script>
    ...
    function redireccionar(valor, carpeta, pila) {
      ...
      //
       //                     
       // //tengo que mandar el id de la peticion que se realizo
       //}
        if (pila == 0) {
