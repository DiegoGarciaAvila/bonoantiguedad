...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        //$str_impresora = TRUE; 
        //$str_impresora_destino='fichas_reporte_sistema/rep_cat_adscripcion.php?';
        ...
        $a_search_campo = array('AClave','ADescripcion');
        ...
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        //$str_javascript='<script src="metodos_javascript/js_cat_adscripcion.js"></script>';
        ...
        **************************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[]=array('ACveA','ACveA','VISTA','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('AClave','Clave','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ADescripcion','Descripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                break;
            case 2:
                /******************SELECTS(EJEMPLO)***********************************************/
                ...
                $field[]=array('ACveA','ACveA','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('AClave','Clave','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ADescripcion','Descripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                break;
            case 3:
                ...
                $field[]=array('ACveA','ACveA','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('AClave','Clave','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('ADescripcion','ADescripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                break;
