        ...
        **************************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[]=array('cve_estatus','cve_estatus','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'100','30');
                $field[]=array('status_descripcion','status_descripcion','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'100','30');
                break;
            case 2:
                /******************SELECTS(EJEMPLO)***********************************************/
