...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        //$str_impresora = TRUE; 
        //$str_impresora_destino='fichas_reporte_sistema/rep_cat_tipodoc.php?';
        ...
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        //$str_javascript='<script src="metodos_javascript/js_cat_tipodoc.js"></script>';
        ...
        **************************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[]=array('TDCveTD','TDCveTD','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('TDDescripcion','DESCRIPCION','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                break;
            case 2:
                /******************SELECTS(EJEMPLO)***********************************************/
