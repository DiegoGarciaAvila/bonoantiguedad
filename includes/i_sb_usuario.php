...
if ($str_check) {
   ...
   if ($consulta->totalRows > 0) {
      ...
      if ($__SESSION->getValueSession('desperfil') == 'ADMINISTRADOR') {
         ...
         // $strWhere = ' WHERE cve_usuario = ' . $__SESSION->getValueSession('cveusuario');
      }
      ...
      $niveles_acceso = array('i_peticiones1completo.php');
      ...
      switch ($_POST['opc']) {
         ...
         case 2:
            ...
            $field[] = array('cve_usuario', 'cve_usuario', 'HIDDEN', 'number', 'NOOBLIGATORIO', 'int', '', array(0, 12), '30', '', array(), '', '');
            $field[] = array('ClaveServidor', 'CLAVE SERVIDOR PUBLICO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 12), '300', '', array(), '', '');
            $field[] = array('nom_usuario', 'NOMBRE USUARIO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');
            $field[] = array('ApePat', 'APELLIDO PATERNO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');
            $field[] = array('ApeMat', 'APELLIDO MATERNO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');

            $field[] = array('cve_perfil', 'ROL', 'VISTA', 'select', 'NOOBLIGATORIO', 'int', $selecDesc, array(0, 6), '30', '', array(), '', '');
            $field[] = array('des_usuario', 'DESCRIPCION DEL USUARIO', 'VISTA', 'select', 'OBLIGATORIO', 'varchar', $desperfil, array(0, 6), '300', '', array(), '', '');

            $field[] = array('email', 'CORREO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');
            $field[] = array('passwd', 'CONTRASEÑA', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');
            $field[] = array('Rfc', 'RFC', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 4), '30', '', array(), '', '');
            $field[] = array('Antiguedad', 'ANTIGUEDAD', 'HIDDEN', 'text', 'NOOBLIGATORIO', 'varchar', '', array(0, 12), '30', 'NA', array(), '', '');

            $field[] = array('CveAds', 'ADSCRIPCION', 'VISTA', 'select', 'NOOBLIGATORIO', 'int',  $selecADS, array(0, 6), '30', '', array(), '', '');
            $field[] = array('FechaIngAds', 'FECHA INGRESO A ADSCRIPCION', 'VISTA', 'date', 'OBLIGATORIO', 'date', '', array(0, 6), '30', '', array(), '', '');

            $field[] = array('Issemmym', 'ISSEMMYM', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 6), '30', '', array(), '', '');
            $field[] = array('FechaIngIss', 'FECHA INGRESO A ISSEMMYM', 'VISTA', 'date', 'OBLIGATORIO', 'date', '', array(0, 6), '30', '', array(), '', '');

            $field[] = array('CveAD', 'ADMINISTRATIVO/DOCENTE', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecAD, array(0, 4), '30', '', array(), '', '');
            $field[] = array('CveAJ', 'ACTIVO/JUBILADO', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecAJ, array(0, 4), '30', '', array(), '', '');
            $field[] = array('Sindicalizado', 'Sindicalizado', 'VISTA', 'select', 'OBLIGATORIO', 'int', $sindicalizado, array(0, 4), '30', '', array(), '', '');

            $field[] = array('CveCD', 'CIUDAD DE DOMICILIO', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecCD, array(0, 6), '30', '', array(), '', '');
            $field[] = array('TelCD', 'TELEFONO DE DOMICILIO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 6), '30', '', array(), '', '');

            $field[] = array('CveCT', 'CIUDAD DE TRABAJO', 'VISTA', 'select', 'OBLIGATORIO', 'int',  $selecCT, array(0, 6), '30', '', array(), '', '');
            $field[] = array('TelCT', 'TELEFONO DE TRABAJO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 6), '30', '', array(), '', '');

            $field[] = array('CveE', 'ESTATUS DE USUARIO', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecEP, array(0, 6), '30', '', array(), '', '');
            $field[] = array('CveM', 'MODALIDAD', 'VISTA', 'select', 'NOOBLIGATORIO', 'int', $selecM, array(0, 6), '30', '', array(), '', '');
            $field[] = array('CvePF', 'PUESTO FUNCIONAL', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecPuesto, array(0, 6), '30', '', array(), '', '');
            $field[] = array('NivelRango', 'NivelRango', 'VISTA', 'text', 'NOOBLIGATORIO', 'int', '', array(0, 6), '30', '', array(), '', '');

            $field[] = array('CveUA', 'UNIDAD EJECUTORA', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecUE, array(0, 4), '30', '', array(), '', '');
            $field[] = array('CveZE', 'ZONA ESCOLAR', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecZE, array(0, 4), '30', '', array(), '', '');
            $field[] = array('cve_organismo', 'ORGANISMO', 'VISTA', 'select', 'NOOBLIGATORIO', 'int', $selecOrg, array(0, 4), '30', '', array(), '', '');
            $field[] = array('FecRegSis', 'FecRegSis', 'HIDDEN', 'text', 'NOOBLIGATORIO', 'int', '', array(0, 4), '30', $fecha, array(), '', '');
         ...
         case 3:
            ...
            $field[] = array('CveAds', 'ADSCRIPCION', 'VISTA', 'select', 'OBLIGATORIO', 'int',  $selecADS, array(0, 6), '30', '', array(), '', '');
            $field[] = array('FechaIngAds', 'FECHA INGRESO A ADSCRIPCION', 'VISTA', 'date', 'OBLIGATORIO', 'date', '', array(0, 6), '30', '', array(), '', '');
            ...
            $field[] = array('CveE', 'ESTADO DE USUARIO', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecEP, array(0, 6), '30', '', array(), '', '');
            $field[] = array('CveM', 'MODALIDAD', 'VISTA', 'select', 'NOOBLIGATORIO', 'int', $selecM, array(0, 6), '30', '', array(), '', '');
            $field[] = array('CvePF', 'PUESTO FUNCIONAL', 'VISTA', 'select', 'OBLIGATORIO', 'int', $selecPuesto, array(0, 6), '30', '', array(), '', '');
            $field[] = array('NivelRango', 'NivelRango', 'VISTA', 'text', 'NOOBLIGATORIO', 'int', '', array(0, 6), '30', '', array(), '', '');
