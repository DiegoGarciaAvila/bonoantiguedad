...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        $boton_texto = "NUEVO GRUPO";
        $campo = array();
        $entidad = 'MÓDULO GRUPO DE USUARIOS';
        ...
        /**************************************************************************/
        /******************JOINS (EJEMPLO)*****************************************/
        $tabla = 'sb_usergroup a';
        $tabla_join = ' LEFT JOIN cat_estatus b on a.cve_estatus=b.cve_estatus';
        $campos_join = 'a.cve_usergroup,a.des_usergroup,b.des_estatus,a.cve_estatus';
        /***************************************************************************/
        /************************SECCION DE LOS BOTONES************************************************************************************/
        //$streditar = TRUE;
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        // $str_javascript='<script src="metodos_javascript/js_sb_usergroup.js"></script>';
        /**********************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[] = array('des_usergroup', 'GRUPO DE USUARIO', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 12), '30', '', array(), '');
                $field[] = array('des_estatus', 'ESTATUS', 'VISTA', 'number', 'OBLIGATORIO', 'int', '', array(0, 12), '30', '', array(), '');
                break;
            case 2:
                $field[] = array('cve_usergroup', 'cve_usergroup', 'HIDDEN', 'number', 'NOOBLIGATORIO', 'int', '', array(0, 12), '30', '', array(), '');
                $field[] = array('des_usergroup', 'GRUPO DE USUARIOS', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 6), '30', '', array(), '');
                $field[] = array('cve_estatus', 'ESTATUS', 'VISTA', 'select', 'OBLIGATORIO', 'int', $vector_estatus, array(0, 6), '30', '', array(), '');
                break;
            case 3:
                $field[] = array('cve_usergroup', 'cve_usergroup', 'HIDDEN', 'number', 'NOOBLIGATORIO', 'int', '', array(0, 12), '30', '', array(), '');
                $field[] = array('des_usergroup', 'GRUPO DE USUARIOS', 'VISTA', 'text', 'OBLIGATORIO', 'varchar', '', array(0, 6), '30', '', array(), '');
