        ...
        switch ($_POST['opc']) {
            case 0:
              ...
              //  $field[]=array('PDocGen','DOCUMENTO DE APROVACION','VISTA','text','NOOBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                ...
                $field[]=array('usuario','SERVIDOR PÚBLICO','VISTA','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'',$str_modal);
