...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        //$str_impresora = TRUE; 
        //$str_impresora_destino='fichas_reporte_sistema/rep_convocatoria.php?';
        ...
        $a_search_campo = array('CNombre');
        $a_search_etiqueta = array('NOMBRE');
        ...
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        //$str_javascript='<script src="metodos_javascript/js_convocatoria.js"></script>';
        ...
        **************************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[]=array('CCveCon','CCveCon','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('CNombre','NOMBRE','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
