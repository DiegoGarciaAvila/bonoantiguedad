...
if ($str_check) {
    ...
    if ($consulta->totalRows > 0) {
        ...
        //$str_impresora = TRUE; 
        //$str_impresora_destino='fichas_reporte_sistema/rep_cita.php?';
        ...
        $a_search_campo = array('CFolio','CFecha','PFolio');
        $a_search_etiqueta = array('FOLIO','FECHA DE CITA','FOLIO DE PETICION');
        ...
        $tabla = 'cita a';
        $tabla_join = 'LEFT JOIN peticiones b ON (a.CCvePfk=b.PCveP)';
        $campos_join = 'a.*,b.PFolio';
        /***************************************************************************/
        /************************SECCION DE LOS BOTONES************************************************************************************/
        //$streditar = TRUE;
        //$streliminar = TRUE;
        //$strnuevo = TRUE;
        //$str_javascript='<script src="metodos_javascript/js_cita.js"></script>';
        ...
        **************************************************************************************************************************************/
        ...
        switch ($_POST['opc']) {
            case 0:
                ...
                $field[]=array('CCveC','CCveC','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
                $field[]=array('CFolio','FOLIO','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('CFecha','FECHA DE CITA','VISTA','date','OBLIGATORIO','date', '', array(0, 12),'30','',array(),'','');
                $field[]=array('PFolio','FOLIO DE PETICION','VISTA','number','OBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
            ...
            case 2:
                ...
                $field[]=array('CFolio','FOLIO','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('CFecha','FECHA DE CITA','VISTA','date','OBLIGATORIO','date', '', array(0, 12),'30','',array(),'','');
                //$field[]=array('CCvePfk','FOLIO DE PETICION','HIDDEN','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
            ...
            case 3:
                ...
                $field[]=array('CFolio','FOLIO','VISTA','text','OBLIGATORIO','varchar', '', array(0, 12),'30','',array(),'','');
                $field[]=array('CFecha','FECHA DE CITA','VISTA','date','OBLIGATORIO','date', '', array(0, 12),'30','',array(),'','');
                //$field[]=array('CCvePfk','FOLIO DE PETICION','VISTA','number','NOOBLIGATORIO','int', '', array(0, 12),'30','',array(),'','');
