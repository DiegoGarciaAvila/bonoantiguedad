...
$query_principal .= $campos . " FROM " . $tabla . $tabla_join . " WHERE " . $clave_principal . "=" . $_POST['id_prin'];
            ...
            <form>
                <div class="row">
                    ...
                    <a href="<?= $_SERVER['HTTP_REFERER'] ?>">ATRAS</a>
                        <h4 class="card-title mb-3"><b><?= $entidad ?></b></h4>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2">
                        ...
                        $strnuevo .= "<button class=\"btn btn-primary btn-icon m-1\" type=\"submit\"><span class=\"ul-btn__icon\"><i class=\"i-Gear-2\"></i></span><span class=\"ul-btn__text\">ACTUALIZAR 🚀</span></button>";
                        echo $strnuevo;
                        ?>
                    </div>
                </div>
                ...
                foreach ($field as $key => &$val) {
                    ...
                    if ($cambia_separador != $val[7][0]) {
                        ...
                        $pinta_separador = '<div style="color: black; background-color: #E4E4E4; width: 100%;" >' . $separadores[$cambia_separador] . '</div>';
