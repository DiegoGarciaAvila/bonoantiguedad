...
?>
    <!-- BEGIN: Main Menu-->
    <div id="menuvertical" name="menuvertical" class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true" style="visibility: hidden">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active nav-item"><a class="d-flex align-items-center" href="../<?=$NOMBRE_CARPETA_PRINCIPAL ?>/index.php?mod=9999"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Home">INICIO</span></a>
                </li>
